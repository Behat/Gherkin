<?php return array (
  ...
  array (
    ...
    'scenario' => 'Keadaan|Situasi|Senario',
    'scenario_outline' => 'Garis Panduan Senario|Kerangka Keadaan|Kerangka Situasi|Kerangka Senario',
    'then' => 'Kemudian|Maka|*',
    'when' => 'Apabila|*',
  ),
  'bs' => 
  ...
  array (
    ...
    'given' => 'Étant donné qu\'<|Etant donné qu\'<|Etant donné que|Étant donné que|Etant données|Étant données|Étant donnés|Étant donnée|Etant donnés|Etant donnée|Etant donné|Étant donné|Soit|*',
    'name' => 'French',
    'native' => 'français',
    'scenario' => 'Scénario',
  ...
  array (
    ...
    'examples' => 'Samplaí',
    'feature' => 'Gné',
    'given' => 'Cuir i gcás nach<|Cuir i gcás nár<|Cuir i gcás gur<|Cuir i gcás go<|*',
    'name' => 'Irish',
    'native' => 'Gaeilge',
    'scenario' => 'Cás',
  ...
  array (
    'and' => 'Un|*',
    'background' => 'Situācija|Konteksts',
    'but' => 'Bet|*',
  ...
  array (
    ...
    'but' => 'Dar|*',
    'examples' => 'Exemple',
    'feature' => 'Funcţionalitate|Funcționalitate|Functionalitate',
    'given' => 'Dati fiind|Daţi fiind|Date fiind|Dați fiind|Dat fiind|*',
    'name' => 'Romanian',
    'native' => 'română',
    'scenario' => 'Scenariu',
    'scenario_outline' => 'Structură scenariu|Structura scenariu',
    'then' => 'Atunci|*',
    'when' => 'Când|Cand|*',
  ),
  'ru' => 
  ...
  array (
    'and' => 'Ter|In',
    'background' => 'Kontekst|Ozadje|Osnova',
    'but' => 'Vendar|Ampak|Toda',
    'examples' => 'Scenariji|Primeri',
    'feature' => 'Funkcionalnost|Značilnost|Lastnost|Možnosti|Funkcija|Moznosti',
    'given' => 'Privzeto|Zaradi|Podano|Dano',
    'name' => 'Slovenian',
    'native' => 'Slovenski',
    'scenario' => 'Scenarij|Primer',
    'scenario_outline' => 'Struktura scenarija|Oris scenarija|Osnutek|Koncept|Skica',
  ...
  array (
    ...
    'feature' => 'poQbogh malja\'|Qu\'meH \'ut|perbogh|laH|Qap',
