...
return array (
  ...
  array (
     'And' => 'І|Таксама|*',
     'Background' => 'Прадгісторыя|Кантэкст',
     'But' => 'А|Але|*',
     'Examples' => 'Прыклады',
     'Feature' => 'Функцыянальнасць|Функцыянал|Уласцівасць|Функцыя',
     'Given' => 'Няхай|Хай|Дапушчанне|Дадзена|*',
     'Name' => 'Belarus',
     'Native' => 'баларускі',
     'Scenario' => 'Сцэнар',
     'Scenario_outline' => 'Структура сцэнарыя',
     'Then' => 'Тады|*',
     'When' => 'Калі|*',
   ),
  'ca' => 
